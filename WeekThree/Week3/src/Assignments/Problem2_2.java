...
public class Problem2_2 {
    ...
    public static void beginning() {
        ...
        System.out.printf("The month is: %s, Leap year: %b, There is %d days in %s ", monthName, leap, daysInTheMonth,
                monthName);
    ...
    public static String getMonthString(int month) {
        // ! do Cases for the number of months (the "!" is part of a extention that i
        // use to color comments)
        String monthName = "";
        switch (month) {
            case 1:
                monthName = "January";
    ...
    /**
     * 
     * @param month takes in the month and uses it to calculate the number of days
     *              in the month
    ...
    public static int getMonthDays(String month, int year) {
        // ! return number of days the given month and year (the "!" is part of a
        // extention that i use to color comments)
        int days = 0;
